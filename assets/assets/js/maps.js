...
function createHomepageGoogleMap(_latitude,_longitude,json,_zoom){
    $.get("assets/assets/external/_infobox.js", function() {
        gMap();
    });
    function gMap(){
        ...
        for (var i = 0; i < json.data.length; i++) {
            ...
            var infoboxOptions = {
                ...
                closeBoxURL: "assets/assets/img/close.png",
        ...
        var clusterStyles = [
            {
                url: 'assets/assets/img/cluster.png',
                height: 34,
                width: 34
            }
        ];
...
function simpleMap(_latitude, _longitude, draggableMarker){
    ...
    google.maps.event.addListener(marker, 'position_changed', function() {
          document.getElementById('current').innerHTML =marker.getPosition();
          document.getElementById('longlat').value =marker.getPosition();
        });
...
function multiChoice(sameLatitude, sameLongitude, json) {
    //if (clickedCluster.getMarkers().length > 1){
        ...
        $('.modal-window').load( 'assets/assets/external/_modal-multichoice.html', function() {
