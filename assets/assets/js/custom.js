...
// Set width for inputs in horizontal search bar -----------------------------------------------------------------------
    ...
    $( "#redefine-search-form" ).load( "assets/assets/external/_search-bar.html", function() {
        setInputsWidth();
        //autoComplete();
    });
...
function autoComplete(){
    if( !$("script[src='assets/assets/js/leaflet.js']").length ){
...
function drawOwlCarousel(_rtl){
    $.getScript( "assets/assets/js/owl.carousel.min.js", function( data, textStatus, jqxhr ) {
    ...
    if( category ){
        if( category != 'blank' ){
            if( json.data[a].item_specific ){
                if( json.data[a].item_specific.likes ){
                    itemSpecific += '<span title="Bedrooms"><i class="fa fa-thumbs-o-up" aria-hidden="true"></i> ' + json.data[a].item_specific.likes + '</span>';
                }
                if( json.data[a].item_specific.views ){
                    itemSpecific += '<span title="Bathrooms"><i class="fa fa-eye" aria-hidden="true"></i> ' + json.data[a].item_specific.views + '</span>';
                }
                if( json.data[a].item_specific.comments ){
                    itemSpecific += '<span title="Area"><i class="fa fa-comment" aria-hidden="true"></i> ' + json.data[a].item_specific.comments + '</span>';
                }
                if( json.data[a].item_specific.garages ){
                    itemSpecific += '<span title="Garages"><img src="assets/assets/img/garages.png">' + json.data[a].item_specific.garages + '</span>';
                }
                return itemSpecific;
            }
        }
